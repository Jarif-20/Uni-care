...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
            <a class="nav-link" href="users.php">Previous Page</a>
            </li>
        </ul>
...
<div class="container mt-5" id="table">
    <div class="table-responsive">
        <table class="table custom-table">
            ...
            <tbody>
                <?php
                $sql = "SELECT h.Name AS hospital_name, bb.Blood_bank_id AS bloodbank_id 
                        FROM Hospital h
                        LEFT JOIN BloodBank bb ON h.Hospital_id = bb.Hospital_id";
